...
@section('content')
    <section id="editPage">
        @foreach ($code->pages as $key => $page)
            @canany(['viewAndUpdate', 'masterUserPage'], $page)
                            ...
                            <div class="col-md-8 codeProperties">
                                <div class="container"> 
                                    <div class="form-group row">
                                        ...
                                        <input id="codeTitle" name="codeTitle" type="text" class="form-control" placeholder="Insert Code Title Here" value="{{$code -> code_title}}" @canany(['fullControl', 'masterUserPage'], $page) @elsecanany(['viewAndUpdate'], $page) {{"readonly"}} @endcanany required>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pageTitle" class="col-md-0 col-form-label text-md-right">Page Title</label>
                                        <input id="pageTitle" name="pageTitle" type="text" class="form-control" placeholder="Insert Title Description for Public Page Here" value="{{$page -> page_title}}" @canany(['fullControl', 'masterUserPage'], $page) @elsecanany(['viewAndUpdate'], $page) {{"readonly"}} @endcanany required>
                                    </div>
                                    <div class="form-group row mb-0">
                                        <div class="container p-0 ml-0">
                                            ...
                                            <select id="chooseSP" name="securityProfile" class="form-control" @canany(['fullControl', 'masterUserPage'], $page) @elsecanany(['viewAndUpdate'], $page) {{"readonly"}} @endcanany>
                                                    ...
                                                    @foreach ($securityProfiles as $securityProfile)
                                                        <option value="{{$securityProfile -> id}}"
                                                            @if (($page -> security_profile_id) === ($securityProfile -> id))
                                                                {{"selected"}}
                                                            @endif
                                                            @canany(['fullControl', 'masterUserPage'], $page) @elsecanany(['viewAndUpdate'], $page) {{"hidden"}} @endcanany
